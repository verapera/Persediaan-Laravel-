...
<!-- modal -->
      ...
      <div class="mb-4">
          ...
          <a class="btn btn-danger" href="/pdf_barangmasuk"><i class="bx bxs-printer"></i> Cetak</a>
      </div>
        <!-- Modal -->
          ...
          <tr>
              @forelse ($barangmasuks as $item)
                  ...
                  <td class="text-center">
                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('barangmasuk.destroy', $item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
